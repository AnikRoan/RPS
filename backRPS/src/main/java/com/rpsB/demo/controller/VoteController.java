...
public class VoteController {
    ...
    public ResponseEntity<VoteResponse> createVote(@PathVariable UUID recipeId,
        ...
        return ResponseEntity.ok().body(voteService.createVote(request, recipeId));
    }
    ...
    public ResponseEntity<VoteResponse> updateVote(@PathVariable UUID recipeId,
                                                   ...
                                                   @RequestBody VoteRequest request) {
        return ResponseEntity.ok().body(voteService.updateVote(request, recipeId, voteId));
    }
    ...
    public ResponseEntity<String> deliteVote(@PathVariable UUID recipeId,
                                             @PathVariable Long voteId) {
        return ResponseEntity.ok().body(voteService.deleteVote(recipeId, voteId));
    }
}
