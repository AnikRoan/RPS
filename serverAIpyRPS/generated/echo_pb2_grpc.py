...
from generated import echo_pb2 as echo__pb2
...
def add_EchoServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'infoToAI.EchoService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('infoToAI.EchoService', rpc_method_handlers)
